(function ($) {
	...
	function format_tweetback(tweetback) {
      ...
      formatted +=       '<a href="http://twitter.com/intent/favorite?tweet_id='+tweetback.permalink_url.split('/').pop()+'"><img src="/images/boastful/favorite.png" width="7px" height="7px" /></a>'
      formatted +=       '<a href="http://twitter.com/intent/tweet?in_reply_to='+tweetback.permalink_url.split('/').pop()+'"><img src="/images/boastful/reply.png" width="7px" height="7px" /></a>'
      formatted +=       '<a href="http://twitter.com/intent/retweet?tweet_id='+tweetback.permalink_url.split('/').pop()+'"><img src="/images/boastful/retweet.png" width="7px" height="7px" /></a>'
      formatted +=     '</div>'
      formatted +=   '</div>'
      formatted += '</div>'
      return formatted
